...
export default function OtherMaterials({
  ...
  const Core3Handler = (e) => {
    ...
    setCore3Amount(
      twoDecimalPlacesIfCents(
        document.getElementById("core3length").value *
          document.getElementById("core3price").value
      )
    );
  };
  const Core6Handler = (e) => {
    ...
    setCore6Amount(
      twoDecimalPlacesIfCents(
        document.getElementById("core6length").value *
          document.getElementById("core6price").value
      )
    );
  };
  ...
  const TSDSTHandler = (e) => {
    ...
    setTSRoll(
      twoDecimalPlacesIfCents(
        (document.getElementById("ts_meter").value *
          document.getElementById("ts_up").value) /
          document.getElementById("ts_dst").value
      )
    );
    setTSPrice(document.getElementById("ts_price").value);
    setTSAmount(
      twoDecimalPlacesIfCents(
        document.getElementById("ts_roll").value *
  ...
  const TCSGluePVCHandler = (e) => {
    ...
    setPVCGlueQty(
      twoDecimalPlacesIfCents(
        (document.getElementById("pvcGlue_meter").value *
          document.getElementById("pvcGlue_up").value) /
          3000
      )
    );
    ...
    setPVCGlueAmount(
      twoDecimalPlacesIfCents(
        PVCGlueQty * document.getElementById("pvcGlue_price").value
      )
    );
  };
  ...
  const SSDSTHandler = (e) => {
    // Side Seal >> Double Side Tape Handler
  ...
  const SSLHHandler = (e) => {
    // Side Seal >> Loop Handle Handler
    setLHPcs(document.getElementById("sslh_pcs").value);
    setLHPrice(document.getElementById("sslh_price").value);
    setLHAmount(
      twoDecimalPlacesIfCents(
        document.getElementById("sslh_pcs").value *
          document.getElementById("sslh_price").value
      )
    );
  };
  const SSCBHandler = (e) => {
    // Side Seal >> Card Board Handler
    setCBPcs(document.getElementById("sscb_pcs").value);
    setCBPrice(document.getElementById("sscb_price").value);
    setCBAmount(
      twoDecimalPlacesIfCents(
        document.getElementById("sscb_pcs").value *
          document.getElementById("sscb_price").value
      )
    );
  };

  const SSRibbonHandler = (e) => {
    // Side Seal >> Double Side Tape Handler
    ...
    setSSRibbonRoll(
      twoDecimalPlacesIfCents(
        (document.getElementById("ssdRibbon_meter").value *
          document.getElementById("ssdRibbon_up").value) /
          document.getElementById("ssdRibbon_dst").value
      )
    );
    setSSRibbonPrice(document.getElementById("ssdRibbon_price").value);
    setSSRibbonAmount(
      twoDecimalPlacesIfCents(
        document.getElementById("ssdRibbon_roll").value *
          document.getElementById("ssdRibbon_price").value
      )
    );
  };
      ...
      <TabPanel value={1}>
        ...
        >
          ...
          <TextField
            ...
            label="Price"
          />
          <span id="soloGlueAmount" style={{ padding: 10, fontWeight: 5000 }}>
            ${TSAmount}
          </span>
        </Stack>
      </TabPanel>
